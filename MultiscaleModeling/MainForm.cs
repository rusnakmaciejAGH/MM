...
namespace grain_growth
{
    public partial class MainForm : Form
    {
        ...
        private void PB_Paint(object sender, PaintEventArgs e)
        {
            ...
            for (int y = 0; y < this.grid.Height; ++y)
            {
                for (int x = 0; x < this.grid.Width; ++x)
                {
                    ...
                    if (c.ID != 0)
                    {
                        e.Graphics.FillRectangle((c.Recrystalized) ? Brushes.Red : this.brushes[c.ID], x * this.GridZoom, y * this.GridZoom, this.GridZoom, this.GridZoom);                        
                    }
                }
            }
        }
        ...
        private void gridGroupBox_Enter(object sender, EventArgs e)
        {
